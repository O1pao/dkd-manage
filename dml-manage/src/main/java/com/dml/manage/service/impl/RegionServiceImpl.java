...
import com.dml.manage.mapper.EmpMapper;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import com.dml.manage.mapper.RegionMapper;
import com.dml.manage.domain.Region;
import com.dml.manage.service.IRegionService;
...
public class RegionServiceImpl implements IRegionService
{
    ...
    public int updateRegion(Region region)
    {
        ...
        // 同步更新员工表中的区域名称
        empMapper.updateRegionNameByRegionId(region.getId(), region.getRegionName());
        return result;
    }
