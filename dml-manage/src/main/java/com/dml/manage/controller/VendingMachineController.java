...
public class VendingMachineController extends BaseController
{
    ...
    @PostMapping
    public AjaxResult add(@RequestBody VendingMachine vendingMachine) throws IOException {
     ...
     */
    @PreAuthorize("@ss.hasPermi('manage:vm:list')")
    @GetMapping("/getFaultyVendingMachineList")
    public AjaxResult getFaultyVendingMachineList() {
        return AjaxResult.success(vendingMachineService.getFaultyVendingMachineList());
    }
}
